...
export default [
	...
	Page(
		...
		Group(
			"Workspaces",
			Row({ opt: b.workspaces.monochrome, title: "Monochrome" }),
			Row({ opt: b.workspaces.iconSize, title: "Icon Size" }),
		),
		Group(
			"Active Window",
			Row({ opt: b.activewindow.monochrome, title: "Monochrome" }),
			Row({ opt: b.activewindow.iconSize, title: "Icon Size" }),
		),
