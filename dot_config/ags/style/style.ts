...
const variables = () => [
	...
	$("hover", t(dark.hover, light.hover)),
	$("active", t(dark.active, light.active)),
	$("accent-bg", t(dark.accent.bg, light.accent.bg)),
	$("accent-fg", t(dark.accent.fg, light.accent.fg)),
	$("accent-tray", t(dark.accent.tray, light.accent.tray)),
	$("accent-settings", t(dark.accent.settings, light.accent.settings)),
	...
	$("font-features", options.font.fontFeatures),
