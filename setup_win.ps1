...
$packages = @(
    "7zip", "bat", "biome", "bruno", "curl", "delta", "dbeaver", "eza", "fastfetch", "fd", "ffmpeg",
    "glow", "go", "gzip", "JetBrainsMono-NF", "jj", "jq", "just", "komorebi", "krita", "lazygit",
    "lua", "luarocks", "make", "mariadb", "Meslo-NF", "mingw", "neovim", "nodejs", "obsidian",
    "podman", "poppler", "pnpm", "postgresql", "python", "ripgrep", "rustup-gnu", "sqlite", "tldr",
