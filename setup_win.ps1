...
$packages = @(
    ...
    "luarocks", "make", "mariadb", "Meslo-NF", "mingw", "neovim", "nodejs", "obsidian", "podman",
    "poppler", "pnpm", "postgresql", "python", "ripgrep", "rustup-gnu", "sqlite", "tableplus",
    "tldr", "topgrade","tree-sitter", "unar", "unzip", "uv", "vlc", "vcredist2022", "vscode",
    "wezterm-nightly", "win32yank", "wget", "whkd", "yarn", "yazi", "yq", "zebar", "zig", "zoom"
)
